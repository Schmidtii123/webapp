...
const Book = ({ docID = "K6PqqAyCeidb7avm0xOA" }) => {
    ...
    return (
      <div className="w-screen min-h-[100svh] fixed top-0 left-0 bg-white slide-from-right">
        ...
        <section className="w-full h-full flex flex-col gap-y-4 pt-8 items-center">
          ...
          {/* text wrapper */}
          <div className="w-full flex flex-col items-start px-8 text-lg py-4">
            <p>
              <span className="font-medium">Studie:</span> {data.major}
            </p>
            <p>
              <span className="font-medium">Semester:</span> {data.semester} kr.
            </p>
            <p>
